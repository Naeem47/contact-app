...
class list12 extends StatefulWidget {
  const list12({super.key});

  @override
  State<list12> createState() => _list12State();
}

class _list12State extends State<list12> {
  @override
    ...
    return Scaffold(
      ...
      body:ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return ListTile( 
            selectedTileColor: Colorconstant.black,
